...
(define (run)
  (command-line
    ...
    #:usage-help
    "Generates an SVG outline of the intersection of a design with the XY"
    "plane."
    ...
    [("-q" "--quantum")
     ...
     ("Generate line segments no bigger than <q> units on"
      ...
      "smoother curves, but also bigger files and more compute time.  In"
      "general, halving the <q> value doubles processing time.")
